...
// Buzzer owner only. GPIO15 always belongs to Secplus2Transport, never PulseOutputs.
class Secplus2Outputs : public ControlOutputs {
 public:
  explicit Secplus2Outputs(Secplus2Transport &port) : port_(port) {}
